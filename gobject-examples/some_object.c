...
static void some_object_finalize(GObject *object)
{
...
static void
some_object_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
...
static void
some_object_set_property(GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec)
{
    SomeObject *self = SOME_OBJECT(object);
